...
pros::Motor flywheel(3, false);	 // flywheel
pros::Motor flywheelbott(1, true);
pros::Vision vision(16);
pros::Distance dist(10);
pros::Motor roller(9, false);
// Wheel motor ports
pros::Motor topleft(17, false);
pros::Motor topright(13, true);
pros::Motor bottleft(8, true);
pros::Motor bottright(12, false);

pros::Motor_Group left({17, 8});
pros::Motor_Group right({13, 12});
...
void autonomous()
{
	...
	// move back
	topleft.move_absolute(1047, 75);
	topright.move_absolute(863, 75);
	bottleft.move_absolute(-1038, 75);
	bottright.move_absolute(-878, 75);
	pros::delay(500);
	...
	/*turn:towards goal
	topleft.move_absolute(1862, 75);
	topright.move_absolute(-1283, 75);
	bottleft.move_absolute(-1889, 75);
	bottright.move_absolute(1286, 75);
	pros::delay(500);
	*/
	...
	Logic for Program:
	- input disk :
	if yellow move forward using tare position and distance: go to closest disks
	- count disk based on color
	- when count reaches 3:
	look for red goal
	-find distance then change piston value depending on distance
	-encoder to angle
